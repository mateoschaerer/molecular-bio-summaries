...
\include{Sum_BC_II/lectures/bcII6/bcII6_glossary}
...
\begin{figure}[H]
    ...
    \subfigure[step 10 of gluconeogenesis]{\includegraphics[width = 0.3\textwidth]{step10.png}}


    \subfigure[enzymatic overview]{\includegraphics[width = 0.7\textwidth]{step10part2.png}}
	\caption{step 1 of gluconeogenesis}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\linewidth]{Sum_BC_II//lectures//bcII6/Acetyl-CoAInhibition.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{Sum_BC_II//lectures//bcII6/graph.png}
