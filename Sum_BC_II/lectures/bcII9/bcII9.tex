...
\include{glossary-definitions9.tex}
...
To form \textbf{\gls{Glycine}} from serine, the enzyme \textbf{\gls{serine hydroxymethyltransferase}} removes a one-carbon unit (a hydroxymethyl group, –CH2OH) from serine. For this it uses tetrahydrofolate, as well as \gls{PLP} (activated vitamin B6) as a \textbf{cofactor}.
\begin{figure}[H]
	\centering
...
\noindent In mammals \textbf{\gls{Cysteine}} is formed from \textbf{\gls{Serine}} and \textbf{\gls{Methionine}}. Here's how:
\begin{enumerate}
...
\begin{figure}[H]
	...
	\subfigure[Structure of riboneuleotide reductase (RNR).]{
		\includegraphics[width=0.45\linewidth]{rnr}
		\label{fig:rnr}
	}
	\hfill
