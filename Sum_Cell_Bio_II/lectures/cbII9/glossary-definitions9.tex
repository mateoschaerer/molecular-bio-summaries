...
\newglossaryentry{fibronectin}{
	name={Fibronectin},
	description={Organizer of the ECM: A large, multidomain glycoprotein of the extracellular matrix (ECM) that binds to integrins and other matrix components such as collagen and heparan sulfate.}
}
...
\newglossaryentry{RGD}{
	name={RGD sequence},
	description={A short amino acid motif (Arg-Gly-Asp) found in fibronectin and other ECM proteins. It is recognized by integrins and mediates cell adhesion to the extracellular matrix.}
}
