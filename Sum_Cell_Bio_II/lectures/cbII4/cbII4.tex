...
\include{Sum_Cell_Bio_II/lectures/cbII4/cbII4_glossary}
...
\begin{figure}[H]
    ...
    \subfigure[Nuclear pore complex]{
        \includegraphics[width=0.45\linewidth]{NPC.png}
        \label{fig:itc}
    }
    ...
    \subfigure[nucleus structure]{
        \includegraphics[width=0.45\linewidth]{NucleusStructure.png}
        \label{fig:ITC_H_L}
    }
