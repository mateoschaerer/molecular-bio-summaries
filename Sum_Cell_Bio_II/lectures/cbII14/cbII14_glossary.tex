...
\newglossaryentry{TIM23}{
    name={TIM23 complex},
    description={A subcomplex of the TIM system in the inner mitochondrial membrane, responsible for translocating presequence-containing proteins from the intermembrane space into the mitochondrial matrix or integrating them into the inner membrane}
}


\newglossaryentry{TIM22}{
    name={TIM22 complex},
    description={A subcomplex of the system located in the inner mitochondrial membrane, specialized in importing and inserting multi-pass transmembrane proteins—particularly carrier proteins—into the inner membrane}
}
...
\newglossaryentry{samcomplex}{
    name={SAM complex},
    description={\textbf{Sorting and Assembly Machinery complex}; a protein complex in the mitochondrial outer membrane that facilitates the insertion and assembly of $\beta$-barrel proteins into the membrane. It includes key subunits such as Sam50, Sam35, and Sam37},
    sort={SAM complex}
}
